...
execute store result entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] Pos[0] double 0.0001 run scoreboard players get #sim_x zc_ctrl
execute store result entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] Pos[1] double 0.0001 run scoreboard players get #sim_y zc_ctrl
execute store result entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] Pos[2] double 0.0001 run scoreboard players get #sim_z zc_ctrl
execute at @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] facing 0.5 65 0.5 run tp @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] ^ ^ ^1 ~ ~
...
execute store result score #sim_tx_unit zc_ctrl run data get entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] Pos[0] 10000
scoreboard players operation #sim_tx_unit zc_ctrl -= #sim_x zc_ctrl
execute store result score #sim_ty_unit zc_ctrl run data get entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] Pos[1] 10000
scoreboard players operation #sim_ty_unit zc_ctrl -= #sim_y zc_ctrl
execute store result score #sim_tz_unit zc_ctrl run data get entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] Pos[2] 10000
scoreboard players operation #sim_tz_unit zc_ctrl -= #sim_z zc_ctrl
...
execute if score #sim_yaw_error zc_ctrl matches ..-5001 run scoreboard players set #sim_yaw_error zc_ctrl -5000
execute store result entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] Rotation[0] float 0.01 run scoreboard players get #sim_yaw zc_ctrl
data modify entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] Rotation[1] set value 0f
execute at @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] rotated as @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] run tp @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] ^ ^ ^-1
...
execute at @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] facing entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] feet run tp @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] ^ ^ ^1
execute store result score #sim_hx_unit zc_ctrl run data get entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] Pos[0] 10000
scoreboard players operation #sim_hx_unit zc_ctrl -= #sim_x zc_ctrl
execute store result score #sim_hy_unit zc_ctrl run data get entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] Pos[1] 10000
scoreboard players operation #sim_hy_unit zc_ctrl -= #sim_y zc_ctrl
execute store result score #sim_hz_unit zc_ctrl run data get entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] Pos[2] 10000
scoreboard players operation #sim_hz_unit zc_ctrl -= #sim_z zc_ctrl
...
execute at @e[type=minecraft:armor_stand,tag=zc_dragon_sim_pos,limit=1] facing entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] feet run tp @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] ^ ^ ^1
execute store result score #sim_vx_unit zc_ctrl run data get entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] Pos[0] 10000
scoreboard players operation #sim_vx_unit zc_ctrl -= #sim_x zc_ctrl
execute store result score #sim_vy_unit zc_ctrl run data get entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] Pos[1] 10000
scoreboard players operation #sim_vy_unit zc_ctrl -= #sim_y zc_ctrl
execute store result score #sim_vz_unit zc_ctrl run data get entity @e[type=minecraft:armor_stand,tag=zc_dragon_sim_vector,limit=1] Pos[2] 10000
scoreboard players operation #sim_vz_unit zc_ctrl -= #sim_z zc_ctrl
scoreboard players operation #sim_dot zc_ctrl = #sim_vx_unit zc_ctrl
scoreboard players operation #sim_dot zc_ctrl *= #sim_hx_unit zc_ctrl
scoreboard players operation #sim_tmp zc_ctrl = #sim_vy_unit zc_ctrl
scoreboard players operation #sim_tmp zc_ctrl *= #sim_hy_unit zc_ctrl
scoreboard players operation #sim_dot zc_ctrl += #sim_tmp zc_ctrl
scoreboard players operation #sim_tmp zc_ctrl = #sim_vz_unit zc_ctrl
scoreboard players operation #sim_tmp zc_ctrl *= #sim_hz_unit zc_ctrl
scoreboard players operation #sim_dot zc_ctrl += #sim_tmp zc_ctrl
scoreboard players operation #sim_dot zc_ctrl /= #c10000 zc_ctrl
