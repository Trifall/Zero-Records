execute if score index gui matches 0..19 if data storage practice:gui pages[1].entries[{active:1b}] run function practice:gui/pages/settings/list_menu
...
execute if score index gui matches 14 run scoreboard objectives setdisplay sidebar
execute if score index gui matches 14 if score fly_chance settings matches 4 run scoreboard objectives setdisplay sidebar custom_diag_fly
execute if score index gui matches 14 if score fly_chance settings matches 3..4 if score one_eighth_fly settings matches 1..3 run function practice:gui/pages/settings/clear_one_eighth
...
execute if score index gui matches 17 run scoreboard players operation one_eighth_fly settings = value gui
execute if score index gui matches 17 run scoreboard objectives setdisplay sidebar
execute if score index gui matches 17 if score one_eighth_fly settings matches 3 run scoreboard objectives setdisplay sidebar custom_1_8_fly
execute if score index gui matches 17 if score one_eighth_fly settings matches 1..3 if score fly_chance settings matches 3..4 run function practice:gui/pages/settings/clear_fly
