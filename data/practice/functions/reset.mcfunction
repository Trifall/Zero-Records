...
execute if score in_lobby flags matches 0 if score active timer matches 1 unless score onecycle flags matches 1 if score abandon_info settings matches 0 run function practice:print_abandoned_config
