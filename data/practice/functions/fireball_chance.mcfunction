...
# vanilla mode reprices organic strafe entries from its last internal count to
# the current crystal count - a crystal broken during Holding starts Strafe
# directly and is left out of that. reduced keeps the map's older 3-of-13.
