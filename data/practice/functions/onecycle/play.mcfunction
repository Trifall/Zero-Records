...
# same absorption pool as spawn_dragon so the killing blow reads uncapped
execute if score disable_dragon settings matches 0 as @e[tag=dragon_pos] at @s run summon minecraft:ender_dragon ~ ~ ~ {DragonPhase:3b,AbsorptionAmount:2048.0f}
